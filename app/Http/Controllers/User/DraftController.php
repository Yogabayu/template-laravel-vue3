...
class DraftController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            // return $this->successRes('Draft updated successfully.', $draft);
    ...
    {
        try {
            $draft = Draft::with(['positions', 'user', 'comments' => function ($query) {
                $query->orderBy('created_at', 'desc');
            }, 'comments.user', 'user.position'])->findOrFail($id);
