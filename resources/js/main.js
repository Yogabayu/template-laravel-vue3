...
app.config.globalProperties.$userPhotoUrl = 'https://templatevue.yogabayuap.com/api/v1/user/photo/';
...
app.config.globalProperties.$filePath = 'https://templatevue.yogabayuap.com/api/v1/file/file/';
